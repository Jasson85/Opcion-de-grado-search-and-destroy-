...
const Login = () => {
 ...
 const handleLogin = async e => {
  ...
  try {
    ...
    localStorage.setItem('userToken','authenticated'); // si no usas JWT, marca simple
...
useEffect(() => {
  ...
  // Evita redirigir si ya estás en /map o si no hay token
